...
- (void)setupPlayerWithModel:(HYMusic *)model  {
    ...
    self.playerItem = [AVPlayerItem playerItemWithURL:[NSURL fileURLWithPath:model.musicUrl]];
    //添加通知
    ...
    MPMediaItemArtwork *artwork = [[MPMediaItemArtwork alloc] initWithImage:self.currentMusic.logo];
